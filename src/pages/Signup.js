...
<div className=' flex justify-center py-5  px-6 bg-lime'>

<div className="w-full max-w-sm py-10 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 bg-black">
...
<div className="space-y-1 text-sm px-5">
   ...
   <div className='px-20 '>
   <button className="font-semibold text-xl px-9 w-full text-white">Sign up</button>
   </div>
</form>
</div>
</div>
