            ...
            <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                    <div className="space-y-1">
                        <h3 className="text-lg font-semibold leading-snug sm:pr-8">Jacket</h3>
                    </div>
                    <div className="text-right">
                        <p className="text-lg font-semibold">INR 1499</p>
                        <p className="text-sm line-through dark:text-gray-400">INR 2000</p>
                    </div>
                </div>
    ...
    <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
        <div className="flex w-full space-x-2 sm:space-x-4">
            ...
            <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                    <div className="space-y-1">
                        <h3 className="text-lg font-semibold leading-snug sm:pr-8">Polo</h3>
                    </div>
                    <div className="text-right">
                    <p className="text-lg font-semibold">INR 1299</p>
                    <p className="text-sm line-through dark:text-gray-400">INR 1700</p>
                    </div>
                </div>
                <div className="flex text-sm divide-x">
                    <button type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
...
<div className="space-y-1 text-right">
    <p>Total amount:
        <span className="font-semibold">INR 2798</span>
    </p>
    <p className="text-sm dark:text-gray-600">Not including taxes and shipping costs</p>
</div>
<div className="flex justify-end space-x-4">
    <Link to="/product" type="button" className="px-6 py-2 border rounded-md dark:border-violet-600">Back
